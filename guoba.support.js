  ...
  return {
    ...
    configInfo: {
      schemas: [
        ...
        { field: 'agent.fallbackModels', label: '回退模型(可选)', bottomHelpMessage: '主模型失败时依次尝试的模型 id，多个用英文逗号分隔（同 provider）；如 gpt-4o,claude-3-5-sonnet', component: 'Input', componentProps: { placeholder: '留空=不回退' } },
